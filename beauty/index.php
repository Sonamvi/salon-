    ...
    <body>
        ...
        <!-- CONTACT FORM
            ...
            <section id="contact" class="contact pb-0">
              ...
              $sql="INSERT INTO `contact form` (`id`, `name`, `email`, `phone`, `message`) VALUES (NULL, '$name', '$email', '$phone', '$message')";
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-3">
                        <ul class="list-inline social-buttons">
                          ...
                          <li class="list-inline-item">
                            <a href="https://www.instagram.com/graceful__143">
